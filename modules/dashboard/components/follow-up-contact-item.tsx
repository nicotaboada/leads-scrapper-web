	...
	return (
		...
		>
			<div className="relative">
				<Avatar className="h-10 w-10 shrink-0 border border-zinc-100 shadow-sm transition-transform group-hover:scale-105 dark:border-zinc-800">
			...
			<div className="flex min-w-0 flex-1 flex-col gap-0.5">
				<span className="truncate text-[13px] leading-tight font-semibold text-zinc-900 dark:text-zinc-100">
					{contact.displayName}
				</span>
